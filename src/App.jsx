...
const NewPurchaseForm=({shopId,shop,onSave,onClose,lastPurchNum})=>{
  ...
  const [supplierList,setSupplierList]=useState(()=>{
    try{
      const s=localStorage.getItem("ros_suppliers_"+shopId);
  ...
  const handleAddSupplier=(newSup)=>{
    setSupplierList(l=>{
      const updated=[newSup,...l];
      try{localStorage.setItem("ros_suppliers_"+shopId,JSON.stringify(updated));}catch{}
      return updated;
    });
  ...
  return(
    ...
    {showNewSup&&(
      <div style={{position:"fixed",inset:0,zIndex:1000,display:"flex",alignItems:"center",justifyContent:"center",padding:16}} onClick={()=>setShowNewSup(false)}>
