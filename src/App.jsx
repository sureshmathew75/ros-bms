                      ...
                      {invSales.length===0?(
                        ...
                        return(
                          <tr key={s.id}
                            ...
                            <td style={{padding:"11px 16px",fontFamily:"DM Mono,monospace",fontWeight:800,color:shop.accent,whiteSpace:"nowrap",fontSize:12}}>
                              {s.id}
                            </td>
                            <td style={{padding:"11px 16px",color:"#374151",whiteSpace:"nowrap",fontSize:12}}>
                              {fmtD(s.date)}
                            </td>
                            <td style={{padding:"11px 16px",fontWeight:700,color:"#0f172a",maxWidth:180,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>
                              {s.customer||"—"}
                            </td>
                            <td style={{padding:"11px 16px",color:"#64748b",fontFamily:"DM Mono,monospace",fontSize:11,whiteSpace:"nowrap"}}>
                              {s.phone||s.contact||"—"}
                            </td>
                            <td style={{padding:"11px 16px",color:"#374151",maxWidth:200,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",fontSize:12}}
                              title={lines}>{lines}</td>
                            <td style={{padding:"11px 16px",fontWeight:800,color:"#0f172a",textAlign:"right",whiteSpace:"nowrap"}}>
                              {fmt(shopId,Number(s.amount)||0)}
                            </td>
