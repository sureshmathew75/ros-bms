  ...
  try {
    ...
    const orders = (data.orders || []).map((o) => {
      ...
      return {
        ...
        // Checked in this order because different checkout flows populate
        // different fields: some capture phone only in the delivery/billing
        // address, some only on the customer record, and some (mostly
        // legacy/POS orders) only on the order itself.
        phone: o.customer?.phone || o.shipping_address?.phone || o.billing_address?.phone || o.phone || "",
